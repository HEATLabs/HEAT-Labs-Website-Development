    ...
    function showPredictionOffMessage() {
        ...
        const messageHTML = `
            <div class="prediction-off-message">
                ...
                <p>Our prediction for the start time was March 26, 2026 at 12:00 UTC, we missed the mark and Alpha 3 hasn't started yet. We're still counting up until we get official news.</p>
            </div>
        `;
