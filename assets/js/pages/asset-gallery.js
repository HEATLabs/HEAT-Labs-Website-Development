...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function createassetGalleryCard(item) {
        ...
        <div class="assetGallery-img-container">
            <img src="${imageSrc}" loading="${loadingStrategy}" decoding="${decodingStrategy}" alt="${item.name}" class="assetGallery-img" ${imageStyle} onerror="this.src='https://raw.githubusercontent.com/HEATLabs/HEAT-Labs-Images/refs/heads/main/placeholder/imagefailedtoload.webp'; this.style.opacity='1'">
        </div>
